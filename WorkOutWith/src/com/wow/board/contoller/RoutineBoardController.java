...
public class RoutineBoardController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("routineBoard 호출완료");
		...
		List<BoardVo> R_BoardList = new BoardService().searchRoutine(selectType, currentPage);
		
		req.setAttribute("R_BoardList", R_BoardList);
