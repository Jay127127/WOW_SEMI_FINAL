        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="건대 핼스장" id="keyword" size="15"> 
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ba403c60aa6e40eb2fefc785dd5314e7"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
...
function removeAllChildNods(el) {   
	...
	<table id="mapTable"border="5" >
      ...
      <!-- 페이징 -->
   	 ...
   	 <br>
   	 <form action="mapWirte" method="post" enctype="multipart/form-data">
            <a href="mapwrite"><button type="button" >글쓰기</button></a>
        </form>
